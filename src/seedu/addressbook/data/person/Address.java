...
public class Address {
    ...
    public static final String MESSAGE_ADDRESS_CONSTRAINTS = "Person addresses to be in this format a/Block, StreetName, Unit, PostalCode>";
    public static final String ADDRESS_VALIDATION_REGEX = "\\d{3}, \\w.+, #\\d{2}-\\d{2,3}, \\d{6}";
